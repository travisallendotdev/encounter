...
export const login = (username: string) =>
  apiFetch('/api/auth/login', dmSchema, post({ username }))

export const listCampaigns = () =>
  apiFetch('/api/campaigns', z.array(campaignSchema))
export const createCampaign = (name: string) =>
  apiFetch('/api/campaigns', campaignSchema, post({ name }))
export const getCampaign = (id: string) =>
  apiFetch(`/api/campaigns/${id}`, campaignSchema)

export const listPcs = (campaignId: string) =>
  apiFetch(`/api/campaigns/${campaignId}/pcs`, z.array(pcSchema))
export const createPc = (
  campaignId: string,
  input: { name: string; playerName: string },
...
export const getEncounter = (id: string) =>
  apiFetch(`/api/encounters/${id}`, encounterDetailSchema)
