...
const variants: Record<Variant, string> = {
  default: 'border-line-2 bg-surface-2 text-fg hover:border-accent-deep hover:bg-surface-3',
  primary:
...
export function Button({
  ...
  return <button type={type} className={`${base} ${variants[variant]} ${sizing} ${className}`} {...props} />
}
